...
namespace CollectionPortal.Module.BusinessObjects
{
    ...
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        ...
        public override void AfterConstruction()
        {
            ...
            _UnitID = (Session.Evaluate<Unit>(CriteriaOperator.Parse("Max(UnitID)"), CriteriaOperator.Parse("")) == DBNull.Value ? 0 : Convert.ToInt32(Session.Evaluate<Unit>(CriteriaOperator.Parse("Max(UnitID)"), CriteriaOperator.Parse("")))) + 1;
        ...
        [Persistent("UnitID")] // this line for read-only columns mapping
        private int _UnitID;
        [RuleRequiredField] // Validation for Required
        [RuleUniqueValue] // Validation for unique value
        [Browsable(false)]

        [PersistentAlias("_UnitID")] // This line for read-only column mapping
        public int UnitID
        {
            get { return _UnitID; }
        }
        ...
        [Association]
        public XPCollection<UOMSchema> UOMSchemas
        {
            get { return GetCollection<UOMSchema>(nameof(UOMSchemas)); }
        }

        [Association]
        public XPCollection<UOMSchemaDetail> UOMSchemaDetails
        {
            get { return GetCollection<UOMSchemaDetail>(nameof(UOMSchemaDetails)); }
        }
    }
}