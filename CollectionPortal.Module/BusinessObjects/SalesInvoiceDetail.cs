...
namespace CollectionPortal.Module.BusinessObjects
{
    ...
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public SalesInvoiceDetail(Session session)
            : base(session)
        {
        }
        public override void AfterConstruction()
        {
            ...
            _SalesInvoiceDetailID = (Session.Evaluate<SalesInvoiceDetail>(CriteriaOperator.Parse("Max(SalesInvoiceDetailID)"), CriteriaOperator.Parse("")) == DBNull.Value ? 0 : Convert.ToInt32(Session.Evaluate<SalesInvoiceDetail>(CriteriaOperator.Parse("Max(SalesInvoiceDetailID)"), CriteriaOperator.Parse("")))) + 1;
            // Place your initialization code here (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument112834.aspx).
        }
        [Persistent("SalesInvoiceDetailID")] // this line for read-only columns mapping
        private int _SalesInvoiceDetailID;
        //[RuleRequiredField] // Validation for Required
        //[RuleUniqueValue] // Validation for unique value
        [Browsable(false)]

        [PersistentAlias("_SalesInvoiceDetailID")] // This line for read-only column mapping
        public int SalesInvoiceDetailID
        {
            get { return _SalesInvoiceDetailID; }
        }
        ...
        [DataSourceCriteria("[Locations][[Oid] = '@this.SalesInvoice.Location.Oid']")]
        ...
        public Unit Unit1
        {
            ...
            set
            {
                SetPropertyValue<Unit>("Unit1", ref fUnit1, value);
                SetQuantity2();
                CalculateAmount();
            }
        }
        ...
        public decimal GrossAmount
        {
            ...
            set
            {
                ...
                if (!IsLoading && !IsSaving && SalesInvoice != null && modified)
                {
                    SalesInvoice.UpdateTotalAmount(true);
                }
            }
        }
        ...
        public SalesInvoice SalesInvoice
        {
            ...
            set { SetPropertyValue<SalesInvoice>(nameof(SalesInvoice), ref _SalesInvoice, value); }
        }
