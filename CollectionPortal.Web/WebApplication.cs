...
namespace CollectionPortal.Web {
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.Web.WebApplication
    public partial class CollectionPortalAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private CollectionPortal.Module.CollectionPortalModule module3;
        private CollectionPortal.Module.Web.CollectionPortalAspNetModule module4;
        ...
        static CollectionPortalAspNetApplication() {
        ...
        #endregion
        public CollectionPortalAspNetApplication() {
            InitializeComponent();
			InitializeDefaults();
        }
        ...
        private void CollectionPortalAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
